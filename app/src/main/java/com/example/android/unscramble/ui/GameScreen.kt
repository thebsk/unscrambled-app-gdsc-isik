...
fun GameScreen(
    ...
    Column(
        ...
        GameLayout(
            ...
            onUserGuessChanged = {
                gameViewModel.onUserGuessChanged(it)
            },
            userGuess = gameViewModel.userGuess,
            onUserGuessCompleted = {
    ...
    AlertDialog(
        ...
        dismissButton = {
            TextButton(
                ...
                Text(text = stringResource(R.string.show_analytics))
            }
        },
        confirmButton = {
            TextButton(
